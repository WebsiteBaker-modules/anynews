...
$(document).ready(function () {
    ...
    $scroll
        .before('<img class="scrollButtons left" src="' + WB_URL + '/modules/cwsoft-anynews/thirdparty/better-coda-slider/images/scroll_left.png" />')
        .after('<img class="scrollButtons right" src="' + WB_URL + '/modules/cwsoft-anynews/thirdparty/better-coda-slider/images/scroll_right.png" />');
